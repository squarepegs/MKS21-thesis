      ...
      <div className="starBox row">
        ...
        <div className="col s2">
          <img
               ...
               src={ this.state.feedback >= 1 ? this.state.on : this.state.off }></img>
        </div>
        <div className="col s2">
          <img
               name="star2"
               ...
               src={ this.state.feedback >= 2 ? this.state.on : this.state.off }></img>
        </div>
        <div className="col s2">
          <img
               name="star3"
               ...
               src={ this.state.feedback >= 3 ? this.state.on : this.state.off }></img>
        </div>
        <div className="col s2">
          <img
               name="star4"
               ...
               src={ this.state.feedback >= 4 ? this.state.on : this.state.off }></img>
        </div>
        <div className="col s2">
          <img
               name="star5"
               ...
               src={ this.state.feedback >= 5 ? this.state.on : this.state.off }></img>
        </div>
        <div className="col s1">
          More Difficult
        </div>
