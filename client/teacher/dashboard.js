...
var drawChart = function(){
    ...
    var MyLineChart = require('react-chartjs').Line;
    
    var LineChartComponent = React.createClass({
      render: function(){
        return (<MyLineChart data={this.state.chartData} options={this.state.chartOptions} width="600" height="400">)
      }
    })
...
var Graph = React.createClass({
  ...
  render: function(){
    return (
      <canvas id="lineChart" width="600" height="400">Foo</canvas>
