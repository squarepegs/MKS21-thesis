...
describe('Socket integration', function(){
  ...
  xit('Should allow student clients to disconnect without disconnecting any other clients', function (done){
    ...
    var client3 = io.connect(socketURL, options);
      ...
      teacher.on('made-game', function (game){
        var room = game.code;
        student2.code = room;
        client1.emit('student-join', student2);
  ...
  xit('Should not allow students to join non-existent games', function (done){
